...
namespace TableCollections
{
...
#endif
    {
        ...
        public bool Add(T1 key1, T2 key2, T3 key3, T4 key4, T5 key5, TValue value)
        {
            if (Contains(key1, key2, key3, key4, key5)) return false;
            this[key1, key2, key3, key4, key5] = value;
            return true;
        }

        public bool Add((T1 key1, T2 key2, T3 key3, T4 key4, T5 key5) keys, TValue value)
        {
            if (Contains(keys.key1, keys.key2, keys.key3, keys.key4, keys.key5)) return false;
            this[keys.key1, keys.key2, keys.key3, keys.key4, keys.key5] = value;
            return true;
        }
...
#endif
    {
        ...
        public bool Add(T1 key1, T2 key2, T3 key3, T4 key4, TValue value)
        {
            if (Contains(key1, key2, key3, key4)) return false;
            this[key1, key2, key3, key4] = value;
            return true;
        }

        public bool Add((T1 key1, T2 key2, T3 key3, T4 key4) keys, TValue value)
        {
            if (Contains(keys.key1, keys.key2, keys.key3, keys.key4)) return false;
            this[keys.key1, keys.key2, keys.key3, keys.key4] = value;
            return true;
        }
...
#endif
    {
        ...
        public bool Add(T1 key1, T2 key2, T3 key3, TValue value)
        {
            if (Contains(key1, key2, key3)) return false;
            this[key1, key2, key3] = value;
            return true;
        }

        public bool Add((T1 key1, T2 key2, T3 key3) keys, TValue value)
        {
            if (Contains(keys.key1, keys.key2, keys.key3)) return false;
            this[keys.key1, keys.key2, keys.key3] = value;
            return true;
        }
...
#endif
    {
        ...
        public bool Add(T1 key1, T2 key2, TValue value)
        {
        ...
        public bool Add((T1 key1, T2 key2) keys, TValue value)
        {
            if (Contains(keys.key1, keys.key2)) return false;
            this[keys.key1, keys.key2] = value;
            return true;
        }
...
#endif
    {
        ...
        public bool Add(T1 key1, TValue value)
        {
